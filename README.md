...
> Рассмотрим подробнее в строке с `"hiddenBlock": true,` -> мы говорим что да, нам нужен скрытый блок, так же мы говорим что нам нужен заголовок в этом скрытом блоке за это отвечает: `"titleMode": true,`, за описание отвечает: `"descriptionMode": true,`
> <br><br>
